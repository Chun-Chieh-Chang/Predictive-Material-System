...
| **V-20260826-44** | 2026-08-26 | **介面自適應縮放、xlsx 動態載入、主檔拖動捲動、工作台整合版**：Navbar 五級縮放驅動根字號（全專案 px→rem 遷移）；人工輸入 50–300% 縮放＋▲▼ 箭頭 1% 連續跳檔（60–140%）；xlsx 改動態 import（首屏 −143 kB gzip，−33%）；主檔寬表長按 300ms 拖動捲動含慣性 +60 fps rAF；業務/生管工作台嵌入完整功能檢視與角色專屬主檔維護區，消除跨頁導航。 |

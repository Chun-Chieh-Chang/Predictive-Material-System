...
graph TD
    ...
    B2 --> C2[OBJ-04~06: 消除各人 Excel/筆記孤島, 集中 8 大主檔單一真相來源]
...
* **衡量指標 (DoD)**：任一品號發生異常偏差時，系統即時於物料需求總覽首頁與訂單列表頂部彈出警示清單。
...
* **具體開發功能**：
  1. 建立統一「數據中心 (Data Center)」，完整集中管理 8 大主檔：
...
| **OBJ-04** | 8 大主檔集中單一真相 | 提高資訊集中度/消除孤島 | `DataTablesView` | **Must Have** |

...
export const DEMO_SAMPLE_DATABASE: SystemDatabase = {
  ...
  product_mold_bom: [
    ...
    // Y管 (MABS)
    {
      ...
      is_primary_mold: true,
      std_mfg_scrap_rate: 0.04,  // V2.0 Plan B: yield_master data is now stored in item_master.std_sorting_yield

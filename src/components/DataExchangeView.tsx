      ...
      <div className="bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-xl shadow-black/5 dark:shadow-black/20 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center space-x-2">
          <button
            ...
            className="flex items-center space-x-1.5 px-3 py-2 rounded-xl text-xs font-semibold bg-sky-50 hover:bg-sky-100 dark:bg-sky-950/80 dark:hover:bg-sky-900 text-[#0284c7] dark:text-sky-300 border border-sky-200 dark:border-sky-800/60 transition-colors cursor-pointer"
          >
          ...
          <button
            ...
            className="flex items-center space-x-1.5 px-3 py-2 rounded-xl text-xs font-medium bg-rose-50 hover:bg-rose-100 dark:bg-rose-950/40 dark:hover:bg-rose-900/60 text-rose-700 dark:text-rose-300 border border-rose-200 dark:border-rose-800/40 transition-colors cursor-pointer"
          >
        ...
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-2xl w-full p-6 shadow-2xl space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-slate-800">
              <div className="flex items-center space-x-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">支援貼上包含 8 大主檔陣列之標準 JSON 物件</p>
                </div>
              </div>
              <button
            ...
            <textarea
              ...
              className="w-full p-3.5 bg-slate-950 text-cyan-300 font-mono text-xs rounded-xl border border-slate-800 focus:border-blue-500 focus:outline-hidden placeholder:text-slate-700"
            />
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              <div className="flex items-center space-x-2 ml-auto">
                <button
                  onClick={() => setShowPasteModal(false)}
                  className="px-4 py-2 rounded-xl text-xs font-semibold text-slate-400 hover:text-slate-200 bg-slate-950 border border-slate-800"
                >
                  取消
                </button>
                <button
                  onClick={handleJsonPastePrecheck}
                  className="flex items-center space-x-1.5 px-4 py-2 rounded-xl text-xs font-bold text-white bg-blue-600 hover:bg-blue-500 transition-colors shadow-md shadow-blue-600/20"
                >

                    ...
                    {edge.label && (
                      ...
                      >
                        <div className="flex items-center justify-center h-full">
                          <span
                            className={`text-[0.9333rem] font-bold px-2.5 py-0.5 rounded-full border shadow-md transition-all ${
                              isConnectedToSelected
              ...
              return (
                ...
                >
                  ...
                  <div className="p-3.5">
                    ...
                    <div className="flex items-start justify-between gap-2 mb-2">
                      <div className="flex items-center gap-2 min-w-0">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-[0.8667rem] text-slate-600 dark:text-slate-400 font-medium truncate">
                            {node.subName}
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="flex items-center justify-between gap-1.5 pt-2 border-t border-slate-100 dark:border-slate-800/80 text-[0.8667rem]">
                      ...
                      {node.subNodes.map((sub) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <span className="text-[0.6rem] font-bold text-slate-700 dark:text-slate-300 mt-1 max-w-[5.6667rem] text-center truncate">
                              {sub.badge}
                            </span>
                          </div>
                        );

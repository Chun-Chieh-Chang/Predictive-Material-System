  ...
  return (
    <div className="space-y-6 pb-16">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-xs">
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div>
            <div className="flex items-center space-x-2">
              <span className="bg-emerald-50 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800/60 text-xs font-bold px-2.5 py-0.5 rounded-md font-mono">
                BACKUP ORCHESTRATOR
              </span>
            </div>
            <h2 className="text-xl font-bold text-slate-900 dark:text-white mt-1">自動化備份系統</h2>
          ...
          <div className="flex flex-wrap gap-3">
            <div className={`px-4 py-3 rounded-xl border ${
              ...
              <div className="flex items-center space-x-1.5">
                <ShieldCheck className={`w-4 h-4 ${config.enabled ? 'text-emerald-600 dark:text-emerald-400' : 'text-slate-400 dark:text-slate-500'}`} />
                <span className="text-xs text-slate-500 dark:text-slate-400">排程</span>
              </div>
              <div className={`text-sm font-bold font-mono mt-0.5 ${config.enabled ? 'text-emerald-700 dark:text-emerald-400' : 'text-slate-500'}`}>
                {config.enabled ? 'ON' : 'OFF'}
              </div>
            </div>

            <div className="px-4 py-3 rounded-xl border bg-slate-50 dark:bg-slate-950/70 border-slate-200 dark:border-slate-800">
              <div className="flex items-center space-x-1.5">
                <Clock className="w-4 h-4 text-sky-600 dark:text-cyan-400" />
                <span className="text-xs text-slate-500 dark:text-slate-400">下次備份</span>
              </div>
              <div className="text-sm font-bold font-mono text-sky-700 dark:text-cyan-300 mt-0.5">
                {config.enabled
            ...
            <div className="px-4 py-3 rounded-xl border bg-slate-50 dark:bg-slate-950/70 border-slate-200 dark:border-slate-800">
              <div className="flex items-center space-x-1.5">
                ...
                <span className="text-xs text-slate-500 dark:text-slate-400">上次備份</span>
              </div>
            ...
            <div className="px-4 py-3 rounded-xl border bg-slate-50 dark:bg-slate-950/70 border-slate-200 dark:border-slate-800">
              <div className="flex items-center space-x-1.5">
                ...
                <span className="text-xs text-slate-500 dark:text-slate-400">日誌筆數</span>
              </div>
              <div className="text-sm font-bold font-mono text-purple-700 dark:text-purple-300 mt-0.5">
                {logs.length} 筆
              </div>
            </div>
          </div>
        ...
        {fsaNote && (
          <div className="mt-4 flex items-start space-x-2 bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800/50 rounded-xl px-4 py-3">
            <AlertTriangle className="w-4 h-4 text-amber-600 dark:text-amber-400 shrink-0 mt-0.5" />
            <p className="text-xs text-amber-800 dark:text-amber-300/90 leading-relaxed">{fsaNote}</p>
          </div>
        )}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-xs space-y-5">
            <div className="flex items-center space-x-3 pb-4 border-b border-slate-100 dark:border-slate-800">
              <div className="w-9 h-9 rounded-xl bg-sky-50 dark:bg-cyan-500/10 text-sky-600 dark:text-cyan-400 border border-sky-200 dark:border-cyan-500/20 flex items-center justify-center">
                <Clock className="w-5 h-5" />
              </div>
              <div>
                <h3 className="text-base font-bold text-slate-900 dark:text-white">排程與觸發設定</h3>
                <p className="text-xs text-slate-500 dark:text-slate-400">自動備份時程與執行模式</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              <label className="text-sm font-bold text-slate-900 dark:text-white flex items-center space-x-2">
                <span className={`w-2.5 h-2.5 rounded-full ${config.enabled ? 'bg-emerald-500 animate-pulse' : 'bg-slate-400 dark:bg-slate-600'}`}></span>
                <span>啟用自動備份排程</span>
              </label>
              <button
            ...
            <div className="bg-slate-50 dark:bg-slate-950/70 p-4 rounded-xl border border-slate-200 dark:border-slate-800/80 space-y-3">
              <label className="text-sm font-bold text-slate-900 dark:text-white block">備份觸發時間（台灣時間 UTC+8）</label>
              <div className="flex items-center space-x-3">
                <input
                  ...
                  className="px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg text-slate-900 dark:text-white font-mono text-sm focus:outline-hidden focus:border-sky-500"
                />
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-xs space-y-5">
            <div className="flex items-center space-x-3 pb-4 border-b border-slate-100 dark:border-slate-800">
              <div className="w-9 h-9 rounded-xl bg-purple-50 dark:bg-purple-500/10 text-purple-600 dark:text-purple-400 border border-purple-200 dark:border-purple-500/20 flex items-center justify-center">
                <FolderOpen className="w-5 h-5" />
              </div>
              <div>
                <h3 className="text-base font-bold text-slate-900 dark:text-white">目錄授權與儲存目標</h3>
                <p className="text-xs text-slate-500 dark:text-slate-400">選擇備份檔案寫入位置</p>
              </div>
            </div>
            ...
            <div className="bg-slate-50 dark:bg-slate-950/70 p-4 rounded-xl border border-slate-200 dark:border-slate-800/80 space-y-3">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="flex items-center space-x-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold bg-purple-700 hover:bg-purple-600 disabled:bg-slate-200 dark:disabled:bg-slate-800 disabled:text-slate-400 dark:disabled:text-slate-600 text-white transition-colors cursor-pointer"
                >
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-xs space-y-4">
            <div className="flex items-center space-x-3 pb-4 border-b border-slate-100 dark:border-slate-800">
              ...
              <div>
                <h3 className="text-base font-bold text-slate-900 dark:text-white">手動立即備份</h3>
                <p className="text-xs text-slate-500 dark:text-slate-400">現在就產生一份完整資料庫封存</p>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full flex items-center justify-center space-x-2 px-4 py-3 rounded-xl text-sm font-bold bg-emerald-600 hover:bg-emerald-500 disabled:bg-slate-200 dark:disabled:bg-slate-800 disabled:text-slate-400 dark:disabled:text-slate-600 text-white transition-colors shadow-xs cursor-pointer"
            >
              {isBackingUp ? (
                <>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-xs space-y-4">
          <div className="flex items-center justify-between pb-4 border-b border-slate-100 dark:border-slate-800">
            <div className="flex items-center space-x-3">
              <div className="w-9 h-9 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-slate-700 flex items-center justify-center">
                <Settings2 className="w-5 h-5" />
              </div>
              <div>
                <h3 className="text-base font-bold text-slate-900 dark:text-white">備份作業日誌</h3>
                <p className="text-xs text-slate-500 dark:text-slate-400">完整操作記錄與狀態追蹤</p>
              </div>
            </div>
            <div className="flex items-center space-x-2">
              <button
                onClick={handleExportLogs}
                className="flex items-center space-x-1 px-2.5 py-1.5 rounded-lg text-xs font-semibold bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 border border-slate-300 dark:border-slate-700 transition-colors cursor-pointer"
                title="匯出日誌 JSON"
              >
              ...
              <button
                ...
                className="flex items-center space-x-1 px-2.5 py-1.5 rounded-lg text-xs font-semibold bg-red-50 hover:bg-red-100 dark:bg-red-950/60 dark:hover:bg-red-900/60 text-red-700 dark:text-red-400 border border-red-200 dark:border-red-900/60 transition-colors cursor-pointer"
                title="清除所有日誌"
              >
                ...
                <div
                  ...
                  className={`p-3.5 rounded-xl border text-xs font-mono space-y-1.5 ${
                    entry.status === 'success'
                      ...
                      : 'bg-red-50/60 dark:bg-red-950/20 border-red-200 dark:border-red-900/40 text-slate-800 dark:text-slate-200'
                  }`}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className={`font-bold ${
                        entry.status === 'success' ? 'text-emerald-700 dark:text-emerald-300' : 'text-red-700 dark:text-red-300'
                      }`}>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-xs space-y-4">
        <div className="flex items-center space-x-3 pb-4 border-b border-slate-100 dark:border-slate-800">
          ...
          <div>
            <h3 className="text-base font-bold text-slate-900 dark:text-white">容量管理與保留策略</h3>
            <p className="text-xs text-slate-500 dark:text-slate-400">控制備份日誌的儲存上限</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-slate-50 dark:bg-slate-950/70 p-4 rounded-xl border border-slate-200 dark:border-slate-800/80 space-y-2">
            <label className="text-sm font-bold text-slate-900 dark:text-white block">最大日誌筆數</label>
            <input
              type="number"
              min={30}
              max={3650}
          ...
          <div className="bg-slate-50 dark:bg-slate-950/70 p-4 rounded-xl border border-slate-200 dark:border-slate-800/80 space-y-2">
            <div className="text-sm font-bold text-slate-900 dark:text-white">當前日誌大小估算</div>
          ...
          <div className="bg-slate-50 dark:bg-slate-950/70 p-4 rounded-xl border border-slate-200 dark:border-slate-800/80 space-y-2">
            <div className="text-sm font-bold text-slate-900 dark:text-white">上次成功備份時間</div>
            <div className="text-sm font-mono text-emerald-700 dark:text-emerald-300 mt-1">
              {lastBackupEntry

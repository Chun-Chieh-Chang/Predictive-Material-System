...
const DATA_SPECIFICATION_DICTIONARY = [
  ...
  { '工作表': '料號基本主檔', '欄位名稱': '客戶代碼', '權責單位': '資材(生管)', '必填/選填': '必填', '允許選項 / 資料型態': '文字代碼 (如 MDX, ICU, OEM)', '勾稽與防呆規則': '用於區分客戶需求權限', '填寫範例': 'MDX' },
  { '工作表': '料號基本主檔', '欄位名稱': '物料類別', '權責單位': '資材(生管)', '必填/選填': '必填', '允許選項 / 資料型態': '【選項】FinishedGoods (成品) / RawMaterial (原料) / WIP (半成品)', '勾稽與防呆規則': '必須明確區分成品或原料，決定展開計算層級', '填寫範例': 'FinishedGoods' },
  { '工作表': '料號基本主檔', '欄位名稱': '外觀顏色', '權責單位': '資材(生管)', '必填/選填': '選填', '允許選項 / 資料型態': '文字 (如 本色, 藍色, 黑色)', '勾稽與防呆規則': '料件色系識別', '填寫範例': '本色' },
  { '工作表': '料號基本主檔', '欄位名稱': '計量單位', '權責單位': '資材(生管)', '必填/選填': '必填', '允許選項 / 資料型態': '【選項】PCS (成品件數) / KG (原料公斤)', '勾稽與防呆規則': '成品一律 PCS，原料一律 KG', '填寫範例': 'PCS' },
  { '工作表': '料號基本主檔', '欄位名稱': '備註說明', '權責單位': '資材(生管)', '必填/選填': '選填', '允許選項 / 資料型態': '文字', '勾稽與防呆規則': '品名完整說明', '填寫範例': 'T接頭 (T-Connector)' },
  ...
  { '工作表': '模具與產能主檔', '欄位名稱': '運行狀態', '權責單位': '製造', '必填/選填': '必填', '允許選項 / 資料型態': '【選項】active (正常量產) / maintenance (保養維修中) / trial (試模階段)', '勾稽與防呆規則': '非 active 模具於 MRP 模擬時會提示保養警訊', '填寫範例': 'active' },

  // 3. 產品模具成型關聯檔 (權責: 工程)
  { '工作表': '產品模具成型關聯檔', '欄位名稱': '品號', '權責單位': '工程', '必填/選填': '必填 (FK)', '允許選項 / 資料型態': '文字 (對應料號主檔)', '勾稽與防呆規則': '必須存在於「料號基本主檔」中', '填寫範例': 'A01-200-131' },
  { '工作表': '產品模具成型關聯檔', '欄位名稱': '模具編號', '權責單位': '工程', '必填/選填': '必填 (FK)', '允許選項 / 資料型態': '文字 (對應模具主檔)', '勾稽與防呆規則': '必須存在於「模具與產能主檔」中', '填寫範例': 'MI17193' },
  { '工作表': '產品模具成型關聯檔', '欄位名稱': '使用原料品號', '權責單位': '工程', '必填/選填': '必填 (FK)', '允許選項 / 資料型態': '文字 (對應原料品號)', '勾稽與防呆規則': '必須對應於採購規則檔設定', '填寫範例': 'TERLUX 2802' },
  ...
  { '工作表': '產品模具成型關聯檔', '欄位名稱': '標準生產損耗率', '權責單位': '工程', '必填/選填': '必填', '允許選項 / 資料型態': '數值 (0.0 ~ 0.2，如 3% 填 0.03)', '勾稽與防呆規則': '射出成型正常調機、啟動與料頭損耗', '填寫範例': '0.03' },
  { '工作表': '產品模具成型關聯檔', '欄位名稱': '備註驗證狀態', '權責單位': '工程', '必填/選填': '選填', '允許選項 / 資料型態': '文字', '勾稽與防呆規則': '工程驗證通過狀態', '填寫範例': '驗證通過' },

  // 4. Sorting良率標準檔 (權責: 製造)
  { '工作表': 'Sorting良率標準檔', '欄位名稱': '品號', '權責單位': '製造', '必填/選填': '必填 (PK, FK)', '允許選項 / 資料型態': '文字 (對應成品品號)', '勾稽與防呆規則': '必須為成品料號', '填寫範例': 'A01-200-131' },
  ...
  { '工作表': '業務預估需求檔', '欄位名稱': '需求品號', '權責單位': '業務', '必填/選填': '必填 (FK)', '允許選項 / 資料型態': '文字 (對應料號主檔)', '勾稽與防呆規則': '必須存在於「料號基本主檔」', '填寫範例': 'A01-200-131' },
  ...
  { '工作表': '業務預估需求檔', '欄位名稱': '填報業務', '權責單位': '業務', '必填/選填': '必填', '允許選項 / 資料型態': '文字 (填表人姓名)', '勾稽與防呆規則': '負責業務窗口姓名', '填寫範例': 'Iris' },
  ...
  { '工作表': '實際訂單檔', '欄位名稱': '訂單品號', '權責單位': '業務', '必填/選填': '必填 (FK)', '允許選項 / 資料型態': '文字 (對應料號主檔)', '勾稽與防呆規則': '必須存在於「料號基本主檔」', '填寫範例': 'A01-200-131' },
  ...
  { '工作表': '實際訂單檔', '欄位名稱': '訂單狀態', '權責單位': '業務', '必填/選填': '必填', '允許選項 / 資料型態': '【選項】confirmed (已確認) / in_production (生產中) / completed (已結案) / cancelled (已取消)', '勾稽與防呆規則': '僅 confirmed 與 in_production 計入需求運算', '填寫範例': 'confirmed' },

  // 8. 庫存與待驗快照檔 (權責: 資材(生管))
  { '工作表': '庫存與待驗快照檔', '欄位名稱': '快照結算日', '權責單位': '資材(生管)', '必填/選填': '必填 (PK)', '允許選項 / 資料型態': '日期字串 (YYYY-MM-DD)', '勾稽與防呆規則': '結算盤點基準日', '填寫範例': '2026-08-20' },
  { '工作表': '庫存與待驗快照檔', '欄位名稱': '料號', '權責單位': '資材(生管)', '必填/選填': '必填 (PK, FK)', '允許選項 / 資料型態': '文字 (對應成品或原料品號)', '勾稽與防呆規則': '必須存在於「料號基本主檔」', '填寫範例': 'A01-200-131' },
